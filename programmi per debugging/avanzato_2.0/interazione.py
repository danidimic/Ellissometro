...
class interazione:
    ...
    def propagazione(self):
        ...
        for k in range(self.nraggi):        
            ...
            if abs( s_.a ) > self.precisione: #CONTROLLA
                ...
                if ii_ == 0 and jj_ == 1:
                    ...
                    #####################################################################################
                        print('Raggio trasmesso da vuoto verso layer:') ############
                        ...
                        print('riflettività = ', i_rif/complex(self.s_quaternions.loc[k, 's'].a))
                        print('trasmissività = ', i_/complex(self.s_quaternions.loc[k, 's'].a))  
                        print() ############
                        print('I = ', i_) ############
                        print('Q = ', q_) ############
                        print('U = ', u_) ############
                    ...
                    print('Raggio trasmesso all esterno:') ############
                    print('k=',k)
                    i_ = complex(self.s_quaternions.loc[k+1, 's'].a) ############
                    q_ = complex(-1j*self.s_quaternions.loc[k+1, 's'].b) ############
                    u_ = complex(-1j*self.s_quaternions.loc[k+1, 's'].c) ############
                    ...
                    if ii_ < jj_:
                        ...
                        print('Raggio riflesso dal substrato:') ###########
        ...
        print('raggi: ')
        h_ = []
        for i in self.s_quaternions.index:
            h_.append(self.s_quaternions['s'][i])
